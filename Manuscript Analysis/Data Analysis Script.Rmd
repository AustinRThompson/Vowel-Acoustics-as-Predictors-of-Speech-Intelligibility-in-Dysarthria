...
gtData <- gtData %>%
  ...
  dplyr::summarize(VSA_mean = mean(VSA, na.rm =T),
                   ...
                   Disp_mean = mean(vowel_ED, na.rm =T),
                   Disp_sd = sd(vowel_ED, na.rm =T),
...
plotData <- tidyr::pivot_longer(AcousticData,
  ...
  dplyr::mutate(Acoustic_Measure = case_when(
    ...
    Acoustic_Measure == "vowel_ED_b" ~ "Corner_Dispersion"
    ),
    Acoustic_Measure = as.factor(Acoustic_Measure),
                Acoustic_Measure = fct_relevel(Acoustic_Measure, c("VSA",
                                                                   ...
                                                                   "VSD_25", 
                                                                   "VSD_75"))) %>%
  dplyr::mutate(Intelligibility_Measure = case_when(Intelligibility_Measure == "transAcc" ~ "OT",
                                                    Intelligibility_Measure == "VAS" ~ "VAS"))
